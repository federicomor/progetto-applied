...
```{r}
vars_final = vars[!(vars%in%vars_to_discard)]
FORMULA_SOCIAL <- paste(paste("Social.well.being","~"), paste(vars_final, collapse = "+"))
...
```{r}
vars_final = vars[!(vars%in%vars_to_discard)]
FORMULA_PSYCH <- paste(paste("Psychological.well.being","~"), paste(vars_final, collapse = "+"))
