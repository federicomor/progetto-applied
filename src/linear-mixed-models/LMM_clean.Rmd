...
# Due slopes
```{r}
#Stesso for di prima, stavolta considero già una slope, in questo caso ATTLNACT, che sembrava dare il maggior miglioramento AIC
#in realtà 0.001808812% (infimo), ma proviamo lo stesso 
#aggiungendo a var 2 un'altra e modificando il primo if si possono aggiungere anche altre slopes una dopo l'altra
#questo è esempio con ATTLNACT

vars2=c(vars,"(ATTLNACT|NEW_VAR)")
n=length(vars2)

i=1
while(i < (n-3)){    #-3 per togliere CNT,IM_PUBLIC,NEW_VAR (già in NEW_VAR)
  slopevar=vars2[i]
