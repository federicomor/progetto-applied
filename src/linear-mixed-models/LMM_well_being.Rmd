...
```{r}
data_woo = data[which(d2 <= 32), ]
print(paste("From",dim(data)[1],"obs we moved to",dim(data_woo)[1]))
print(paste("Percentuale di dati sopravvissuti:",dim(data_woo)[1]/dim(data)[1]*100,"%"))

minimum = min
x1 = (data_woo$Approach.to.ICT)^3
x2 = (data_woo$Use.of.ICT)
x3 = (data_woo$Teachers..degree)
x4 = (data_woo$Teacher.skill)
x5 = (data_woo$ESCS)^3
x6 = (data_woo$RATCMP1)
x7 = (data_woo$ICTSCH)^3
x8 = exp((data_woo$HEDRES))
x9 = (data_woo$STUBEHA)^3
x10 = (data_woo$ATTLNACT)^3
x11 = exp((data_woo$JOYREAD))
x12 = (data_woo$PROAT6)
x13 = (data_woo$CLSIZE)
x14 = (data_woo$EDUSHORT)^3
x15 = (data_woo$STAFFSHORT)^3
x16 = (data_woo$PV1MATH)
x17 = log((data_woo$PV1READ)+abs(minimum((data_woo$PV1READ)))+1)
y = (data_woo$Social.well.being)
# y = log((data_woo$Social.well.being)+abs(minimum((data_woo$Social.well.being)))+1)
