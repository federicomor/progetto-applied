...
## [UP] Test con DATA full e trasformazioni
```{r}
data_woo = data[which(d2 <= 27), ]
print(paste("From",dim(data)[1],"obs we moved to",dim(data_woo)[1]))
print(paste("Percentuale di dati sopravvissuti:",dim(data_woo)[1]/dim(data)[1]*100,"%"))
```
...
### Trying box cox
```{r}
lambda = powerTransform(cbind(
  x1 = 1+(data_woo$Approach.to.ICT)+abs(min((data_woo$Approach.to.ICT))),
  x2 = 1+(data_woo$Use.of.ICT)+abs(min((data_woo$Use.of.ICT))),
  x3 = 1+(data_woo$Teachers..degree)+abs(min((data_woo$Teachers..degree))),
  x4 = 1+(data_woo$Teacher.skill)+abs(min((data_woo$Teacher.skill))),
  x5 = 1+(data_woo$ESCS)+abs(min((data_woo$ESCS))),
  x6 = 1+(data_woo$RATCMP1)+abs(min((data_woo$RATCMP1))),
  x7 = 1+(data_woo$ICTSCH)+abs(min((data_woo$ICTSCH))),
  x8 = 1+(data_woo$HEDRES)+abs(min((data_woo$HEDRES))),
  x9 = 1+(data_woo$STUBEHA)+abs(min((data_woo$STUBEHA))),
  x10 = 1+(data_woo$ATTLNACT)+abs(min((data_woo$ATTLNACT))),
  x11 = 1+(data_woo$JOYREAD)+abs(min((data_woo$JOYREAD))),
  x12 = 1+(data_woo$PROAT6)+abs(min((data_woo$PROAT6))),
  x13 = 1+(data_woo$CLSIZE)+abs(min((data_woo$CLSIZE))),
  x14 = 1+(data_woo$EDUSHORT)+abs(min((data_woo$EDUSHORT))),
  x15 = 1+(data_woo$STAFFSHORT)+abs(min((data_woo$STAFFSHORT))),
  x16 = 1+(data_woo$PV1MATH)+abs(min((data_woo$PV1MATH))),
  x17 = 1+(data_woo$PV1READ)+abs(min((data_woo$PV1READ))),
  y = 1+(data_woo$Social.well.being)+abs(min((data_woo$Social.well.being)))
  ))
```
...
Estimated transformation parameters 
  ...
  1.4844658   0.7817783   0.6553601   1.2294882   1.0627735  -0.7602978   1.4921025 
         x8          x9         x10         x11         x12         x13         x14 
  1.7156423   1.3847162   1.5474337   1.0903386 -27.0332555  -0.8678067   0.7323938 
        x15         x16         x17           y 
  0.7830967   2.0012668   2.2461922   1.4026294 
```

```{r}
x1 = bcPower(1+(data_woo$Approach.to.ICT)+abs(min((data_woo$Approach.to.ICT))),lambda$lambda[1])
x2 = bcPower(1+(data_woo$Use.of.ICT)+abs(min((data_woo$Use.of.ICT))),lambda$lambda[2])
x3 = bcPower(1+(data_woo$Teachers..degree)+abs(min((data_woo$Teachers..degree))),lambda$lambda[3])
x4 = bcPower(1+(data_woo$Teacher.skill)+abs(min((data_woo$Teacher.skill))),lambda$lambda[4])
x5 = bcPower(1+(data_woo$ESCS)+abs(min((data_woo$ESCS))),lambda$lambda[5])
x6 = bcPower(1+(data_woo$RATCMP1)+abs(min((data_woo$RATCMP1))),lambda$lambda[6])
x7 = bcPower(1+(data_woo$ICTSCH)+abs(min((data_woo$ICTSCH))),lambda$lambda[7])
x8 = bcPower(1+(data_woo$HEDRES)+abs(min((data_woo$HEDRES))),lambda$lambda[8])
x9 = bcPower(1+(data_woo$STUBEHA)+abs(min((data_woo$STUBEHA))),lambda$lambda[9])
x10 = bcPower(1+(data_woo$ATTLNACT)+abs(min((data_woo$ATTLNACT))),lambda$lambda[10])
x11 = bcPower(1+(data_woo$JOYREAD)+abs(min((data_woo$JOYREAD))),lambda$lambda[11])
x12 = bcPower(1+(data_woo$PROAT6)+abs(min((data_woo$PROAT6))),lambda$lambda[12])
x13 = bcPower(1+(data_woo$CLSIZE)+abs(min((data_woo$CLSIZE))),lambda$lambda[13])
x14 = bcPower(1+(data_woo$EDUSHORT)+abs(min((data_woo$EDUSHORT))),lambda$lambda[14])
x15 = bcPower(1+(data_woo$STAFFSHORT)+abs(min((data_woo$STAFFSHORT))),lambda$lambda[15])
x16 = bcPower(1+(data_woo$PV1MATH)+abs(min((data_woo$PV1MATH))),lambda$lambda[16])
x17 = bcPower(1+(data_woo$PV1READ)+abs(min((data_woo$PV1READ))),lambda$lambda[17])
y = bcPower(1+(data_woo$Social.well.being)+abs(min((data_woo$Social.well.being))),lambda$lambda[18])
```
...
fm = fit_social_lmm_woo
shapiro.test(resid(fm))$p*100
shapiro.test(unlist(ranef(fm)))$p*100
```


## [UP] Confronto valori con&senza asunzioni
```{r}
numerical_variables = c(1:23,25,26)
lmm_social = lmer(FORMULA_SOCIAL_LMM,data=data)
lmm_social_woo = lmer(FORMULA_SOCIAL_LMM,data=data_woo)

data_scaled = data
data_scaled[,numerical_variables] = data.frame(scale(data_scaled[,numerical_variables]))
data_woo_scaled = data_woo
data_woo_scaled[,numerical_variables] = data.frame(scale(data_woo_scaled[,numerical_variables]))

lmm_social_scaled = lmer(FORMULA_SOCIAL_LMM,data=data_scaled)
lmm_social_woo_scaled = lmer(FORMULA_SOCIAL_LMM,data=data_woo_scaled)
```


```{r}
for (i in 1:length(fixef(lmm_social)))
  print(fixef(lmm_social)[[i]]-fixef(lmm_social_woo)[[i]])
```

```{r}
for (i in 1:length(fixef(lmm_social)))
  print(fixef(lmm_social)[[i]]-fixef(lmm_social_scaled)[[i]])
```


```{r}
for (i in 1:length(fixef(lmm_social)))
  print(fixef(lmm_social_scaled)[[i]]-fixef(lmm_social_woo_scaled)[[i]])

# tutte intorno allo zero => coefficienti molto simili
```

```{r}
for (i in 1:length(fixef(lmm_social)))
  print(paste(levels(data$NEW_VAR)[i], ":",
              ranef(lmm_social)$NEW_VAR[[1]][i]-ranef(lmm_social_scaled)$NEW_VAR[[1]][i]))
```
...
for (i in 1:length(fixef(lmm_social)))
  print(paste(levels(data$NEW_VAR)[i], ":",
              ranef(lmm_social_scaled)$NEW_VAR[[1]][i]-ranef(lmm_social_woo_scaled)$NEW_VAR[[1]][i]))
```

```{r}
for (i in 1:length(fixef(lmm_social)))
  print(paste(levels(data$NEW_VAR)[i], ":",
              ranef(lmm_social)$NEW_VAR[[1]][i]-ranef(lmm_social_woo)$NEW_VAR[[1]][i]))
```


```{r}
dotplot(ranef(lmm_social, condVar=T))$NEW_VAR
dotplot(ranef(lmm_social_woo, condVar=T))$NEW_VAR
dotplot(ranef(lmm_social_scaled, condVar=T))$NEW_VAR
dotplot(ranef(lmm_social_woo_scaled, condVar=T))$NEW_VAR
```
...
```{r}
print("lmm_social")
shapiro.test(resid(lmm_social))$p*100
shapiro.test(unlist(ranef(lmm_social)))$p*100
print("lmm_social_woo")
shapiro.test(resid(lmm_social_woo))$p*100
shapiro.test(unlist(ranef(lmm_social_woo)))$p*100
print("lmm_social_scaled")
shapiro.test(resid(lmm_social_scaled))$p*100
shapiro.test(unlist(ranef(lmm_social_scaled)))$p*100
print("lmm_social_woo_scaled")
shapiro.test(resid(lmm_social_woo_scaled))$p*100
shapiro.test(unlist(ranef(lmm_social_woo_scaled)))$p*100

```

```{r}
ranef(lmm_social)
ranef(lmm_social_woo)
```


```{r}
plot(1:28,(ranef(lmm_social)$NEW_VAR-ranef(lmm_social_woo)$NEW_VAR)[[1]],col="white")
text(1:28,(ranef(lmm_social)$NEW_VAR-ranef(lmm_social_woo)$NEW_VAR)[[1]],
     levels(new_var),cex=0.5)
abline(h=0)
```
...
```
data               data_woo
CZE-0 -1.03223702  CZE-0 -0.64847656 
DNK-0  0.18220201  DNK-0  0.15738307 
ESP-0  1.81429513  ESP-0  1.56886356 
EST-0 -0.93816819  EST-0 -0.87577076 
FIN-0 -0.58318348  FIN-0  0.17206834 
FRA-0 -0.16553861  FRA-0 -0.17985106 
GRC-0  0.22097409  GRC-0 -0.15841796 
HRV-0  0.30390358  HRV-0  0.29180672 
HUN-0  0.59793900  HUN-0  0.35457338 
LTU-0  0.22226070  LTU-0  0.10892671 
LUX-0 -0.19237749  LUX-0 -0.46416994 
POL-0 -1.51811704  POL-0 -0.98845028 
SVK-0 -0.54358967  SVK-0 -0.08382285 
SVN-0  0.82472796  SVN-0  0.30932474 
CZE-1 -0.76333288  CZE-1 -0.73002220 
DNK-1  0.50270742  DNK-1  0.38612674 
ESP-1  1.62449750  ESP-1  1.43951208 
EST-1 -0.75526857  EST-1 -0.84407524 
FIN-1 -0.27556345  FIN-1 -0.16710567 
FRA-1  0.06511058  FRA-1  0.03481049 
GRC-1  0.46251586  GRC-1  0.58322661 
HRV-1  0.57320836  HRV-1  0.49723024 
HUN-1  0.35718375  HUN-1  0.27221653 
LTU-1 -0.06595413  LTU-1 -0.09223659 
LUX-1  0.31347114  LUX-1  0.10713117 
POL-1 -0.99833307  POL-1 -0.91523634 
SVK-1 -0.39041740  SVK-1 -0.24548464 
SVN-1  0.15708389  SVN-1  0.10991974 
```
...
Se qualcuno vuole indagare cosa/se hanno di speciale i dati che abbiamo scartato considerandoli outliers, per far riottenere tutte le assunzioni al modello LM e LMM.
Tipo se appartengono a poche classi di stati, se sono outliers perché troppo migliori o troppo peggiori, ecc.

Questi sarebbero i dati da analizzare:
