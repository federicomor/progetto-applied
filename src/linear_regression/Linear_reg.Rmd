...
clt_beta_comb = (-0.028202) * df$col2_clt+
    ( 0.005754) * df$col3_clt

    (-0.008007) * df$col1_fam

tch_beta_comb = ( 0.034128) * df$col1_tch+
    (-0.068108) * df$col2_tch

sch_beta_comb = ( 0.007906) * df$col1_sch+
