...
psi_1 = c("ATTLNACT","COMPETE","EUDMO","RESILIENCE") # sociale
...
dim(df_sc)
colnames(df_sc)
names= c(colnames(df_sc),"PC1_psi","PC2_psi","PC3_psi","PC4_psi","PC5_psi","PC6_psi")
...
# col2_clt: contrasto tra gioia di lettura (+) e risorse educative (-), quindi amore per la cultura contro la
# sua effettiva disponibilità. Alta se uno è interessato alla cultura ma in casa non ha molte risorse. Bassa se 
# uno ha molte risorse ma non è interessato.
# 
