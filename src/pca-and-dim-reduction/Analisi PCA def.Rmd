...
## tch - FORSE FATTO, avanzerebbero 3 pcs
```{r}
...
## sch - FORSE FATTO, avanzerebbero 5 pcs
```{r}
sch=c("ICTSCH","RATCMP1","STRATIO","SCHSIZE","CLSIZE","CREACTIV","EDUSHORT","STAFFSHORT")

# sch_1 = c("SCHSIZE","STRATIO","CREACTIV")
# sch_3 = c("SCHSIZE","STAFFSHORT","CREACTIV")
# sch_2 = c("CLSIZE","EDUSHORT","STRATIO")
# 
# sch_1 = c("ICTSCH","RATCMP1","CLSIZE","EDUSHORT")
# sch_2 = c("SCHSIZE","STRATIO","CREACTIV","STAFFSHORT","EDUSHORT")
# 
sch_1 = c("SCHSIZE","STAFFSHORT","RATCMP1") # disponibilità risorse
sch_2 = c("ICTSCH","STRATIO","CLSIZE") # gestionabilità degli studenti
sch_3 = c("CREACTIV","EDUSHORT") # disponibilità per attività extracurricolari
