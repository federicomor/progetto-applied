...
## clt
```{r}
clt = c("ATTLNACT","STUBEHA","JOYREAD","SCREADCOMP","HEDRES","CULTPOSS","LMINS","MMINS")
clt_1 = c("ATTLNACT","STUBEHA")
clt_2= c("JOYREAD","SCREADCOMP")
clt_3= c("HEDRES","CULTPOSS")
clt_4 = c("LMINS","MMINS")
...
sch_1 = c("CREACTIV","EDUSHORT","STAFFSHORT")
sch_2 = c("ICTSCH","RATCMP1")
sch_3 = c("")
# "EDUSHORT","STAFFSHORT") # size 
