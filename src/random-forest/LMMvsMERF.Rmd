...
```{r}
root_proj_dir = "../../"
dataset_path = paste(root_proj_dir,"data/revisedPCA-datasets/scores_data_wo_outliers.csv",
                     sep="")
...
saving_dir <- paste(root_proj_dir,"data/revisedPCA-datasets/final_scores.csv",
                     sep="")
...
# [5] Appendix: Comparison with simple LM
