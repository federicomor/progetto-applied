...
```{r}
fit_lmerf$forest.model$rsq


sum((pisa_data$Social.well.being - fitted.lmerf(fit_lmerf))^2)
...
```{r}
sum((pisa_data$Social.well.being-predict.lmerf(fit_lmerf,pisa_data[,regressors],group=pisa_data$CNT))^2)
```
