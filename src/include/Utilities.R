...
what_is[["TEACHSUP"]] = "Teacher support in test language lessons (WLE)"
what_is[["STIMREAD"]] = "Teacher's stimulation of reading engagement perceived by student (WLE)"
what_is[["PROAT5AB"]] = "Index proportion of all teachers ISCED LEVEL 5A Bachelor"
what_is[["PROAT5AM"]] = "Index proportion of all teachers ISCED LEVEL 5A Master"
what_is[["PROAT6"]] = "Index proportion of all teachers ISCED LEVEL 6"
what_is[["TOTAT"]] = "Total number of all teachers at school"
